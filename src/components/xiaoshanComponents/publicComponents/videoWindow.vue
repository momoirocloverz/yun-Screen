  ...
  >
      ...
      <div class="control">
        <div class="control-panel">
          ...
          >
            <div
              class="arrow-inside"
              :class="[index===currentArrow?'active-arrow':'']"
              @click="holderRotate(index)"
            >
              <img
    ...
    >
      ...
      <div class="body">
        ...
        >
          <span>{{ item.type }}</span>
          <span>{{ item.eventTime | getTime }}</span>
        </div>
      </div>
    </div>

    <div
      class="mideasquare-img"
      v-show="showImg"
    >
      <div class="mideasquare-title">
        <img
    ...
    <div
      class="mideasquare-detail"
      v-show="showDetail"
    >
      <img
        class="event-img"
        src="../../assets/img/fakeImg.jpg"
        alt=""
      />
      <span
        class="X_icon"
...
.mideasquare .tableList .head {
  width: 95%;
  height: 35px;
  background: url('../../../static/images/tablebg.png') no-repeat;
  background-size: 200%;
  display: flex;
  margin-bottom: 2px;
}
...
.mideasquare .tableList .body .row {
  width: 100%;
  height: 35px;
  background: url(../../../static/images/no1bg.png) no-repeat;
  background-size: 200%;
  display: flex;
  margin-bottom: 1px;
  cursor: pointer;
