<template>
  <div id="header" class="header">
    <div class="pageBtn page_1" @click="routerJump('/page1')"></div>
    <div class="pageBtn page_2" ></div>
    <div class="headerImg">
      <div class="weather">
        <img
          class="address"
      ...
      <img class="img" src="../../../assets/img2/txt.png" alt="" srcset="">
      <div class="date">
...
.header {
  ...
  .page_1{
    left: 250px;
    background: url('../../../assets/img2/11.png') no-repeat center;
    background-size: 100%;
  }
  .page_2{
    right: 250px;
    background: url('../../../assets/img2/22.png') no-repeat center;
    background-size: 100%;
  }
}
.headerImg {
