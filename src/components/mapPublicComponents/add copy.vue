    ...
    <div class="info-container">
      ...
      <div class="body">
        <el-form ref="form" :model="formData" label-width="140px">
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="文物名称：">
                <el-select size="mini" v-model="formData.pointId" placeholder="请选择文物">
                  <el-option v-for="item in wwListData" :key="item.id" :label="item.publishName" :value="item.id"></el-option>
                </el-select>
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="属地镇街：">
                <el-select size="mini" v-model="formData.zjmc" placeholder="请选择镇街">
                  <el-option v-for="item in streetData" :key="item.id" :label="item.name" :value="item.name"></el-option>
                </el-select>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="直接责任单位：">
                <el-input size="mini" v-model="formData.zrdw"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="12">
              <el-form-item label="主要责任人：">
                <el-input size="mini" v-model="formData.zjfzr"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="主要责任人：">
                <el-input size="mini" v-model="formData.dwfzr"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="12">
              <el-form-item label="联系电话：">
                <el-input size="mini" v-model="formData.zjlxdh"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="联系电话：">
                <el-input size="mini" v-model="formData.dwlxdh"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item label="文物受损情况说明：">
                <el-input type="textarea" :rows="5" size="mini" v-model="formData.damageInfo"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="12">
              <el-form-item label="限期时间：">
                <el-date-picker v-model="formData.deadLine" type="date" placeholder="选择日期" size="small" value-format="yyyy-MM-dd" />
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
