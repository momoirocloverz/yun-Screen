      ...
      <div class="body">
        <div class="item" v-for="(item, index) in taskList" :key="index">
          <div class="title-info">
            <div class="info">
              <div class="row1">
                <div class="status" :style="{ background: `url(${getImgStatus(item.status)}) no-repeat center`, 'background-size': '100% 100%' }">{{ item.status | statusChange }}</div>
                <div class="title">{{ item.content && item.content.length > 58 ? item.content.substr(0, 58) + '...' : item.content.substr(0, 58) }}</div>
              </div>
              <div class="row2">
            ...
            <div class="btn" @click="btnClick(item)">
              详情
              <i v-if="currentId == item.id" class="el-icon-arrow-down"></i>
          ...
          <div class="detail-info" v-show="currentId == item.id">
            ...
            <div class="file">
              <div class="part" v-show="imgArr_1.length > 0">
                ...
                <div class="img">
                  <vue-viewer v-for="(item, index) in imgArr_1" :key="index" multiple class="imgShow" list-ul-class="image-list" :thumb="item" :full="item" />
                </div>
              </div>
              <div class="part" v-show="imgArr_2.length > 0">
                ...
                <div class="img">
                  <vue-viewer v-for="(item, index) in imgArr_2" :key="index" multiple class="imgShow" list-ul-class="image-list" :thumb="item" :full="item" />
                </div>
              </div>
            </div>
          </div>
