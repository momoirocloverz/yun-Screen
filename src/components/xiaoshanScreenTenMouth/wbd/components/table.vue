<template>
  <div class="box-table" :style="{ 'font-size': fontSize ? fontSize : '16px' }">
    ...
    >
      ...
      <span v-if="hasIndex" style="flex:0.5;justify-content: center;">序号</span>
      <span
    ...
    <div class="body">
      <div
        :class="['row', isStripe ? 'row_stripe' : '', isSpecal ? 'row_specal' : '', item.warningCount == 1 ? 'row-yellow' : item.warningCount >= 2 ? 'row-red' : '']"
      ...
      >
        ...
        <span v-if="hasIndex" style="flex:0.5; justify-content: center;">{{ index + 1 }}</span>
        <span
        ...
        >
          ...
          <i class="ellSelf" :title="item && item[val.props] ? item[val.props] : ''">
