...
import peopleChart from './newComponents/peopleChart';
import materialChart from './newComponents/materialChart';
import skillChart from './newComponents/skillChart';
import {
  get_yxzs_data,
  get_yxzs_line_data,
...
export default {
  components: {
    ...
    skillChart,
    countTo,
    humanModal: () => import(/* webpackChunkName: "yxzshumanModal" */ '../yxzsDetails/components/humanModal.vue'),
    materialModal: () => import(/* webpackChunkName: "yxzsmaterialModal" */ '../yxzsDetails/components/materialModal.vue'),
    smartModal: () => import(/* webpackChunkName: "yxzssmartModal" */ '../yxzsDetails/components/smartModal.vue'),
  },
  data() {
    return {
      humanType: '',
  ...
  methods: {
    ...
    _get_yxzs_line_data() {
      ...
      this.materialData = [];
      this.skillData = [];
      get_yxzs_line_data({ bumpPointId: '' }).then((res) => {
    ...
    // 获取物防四个统计数据
    _get_WF_tj_data() {
      get_WF_tj_data({ bumpPointId: '' }).then((res) => {
