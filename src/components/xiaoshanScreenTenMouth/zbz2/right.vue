    ...
    <div class="v2">
      <Box :height="'620px'" :bgSrc="require('../../../assets/imgBoxBg/zbz-box7-bg.png')">
        <div class="part-1">
          ...
          <div class="camera-box" v-if="isShowVideoBox">
  ...
  data() {
    return {
      ...
      listData: [
        {
          task: '上报事件',
          createTime: '2022-10-12 14:57:26',
          content: '巡查员上报：文物损坏',
        },
        {
          task: '部门移交',
          createTime: '2022-10-12 14:57:05',
          content: '巡查员上报：文物损坏',
        },
        {
          task: '上级督办',
          createTime: '2022-10-12 14:55:59',
          content: '巡查员上报：文物损坏',
        },
      ],
      lineData_1: [
      ...
      cameraList: [        
        ...
        {
          name: '务本堂西南走道1',
          cameraId: '8ca3555bcc04444096baebfa71e84e48',
        },
        {
          name: '务本堂西走廊2',
          cameraId: 'bf2528f7e5f14fbea5d13dbac1823309',
        }        
      ],
      // part2
      tableColumn_jjsj: [
