<template>
  <div class="dialog-pop" v-bind:data-level="levelNum" v-bind:style="'z-index:'+zIndex" v-bind:ref="'dialog-'+levelNum">
    <div v-bind:class="'dialog-pop-panel '+umMoveClass"
      ...
      <img class="dialog-pop-bg" src="../assets/window_back.png"/>
      <div class="dialog-pop-panelmain">
        <div class="dialog-pop-top">
          <span class="dialog-pop-title"><font-awesome-icon class="dialog-pop-fai" :icon=titleImg fixed-width></font-awesome-icon>{{title}}</span>
...
<style>
  * {
  ...
  .dialog-pop-bg{
    position: absolute;
    opacity: 1;
    filter: drop-shadow(0px 0px 14px #11264D);
  }
  .dialog-pop-panel{
  ...
  .dialog-pop-fai{margin:0 5px 0 0;font-size:16px;text-shadow:0 0 2px #00ffff}
  ...
  .dialog-pop-body::-webkit-scrollbar{
    width: 8px;     /*高宽分别对应横竖滚动条的尺寸*/
    height: 4px;
  }
  .dialog-pop-body::-webkit-scrollbar-thumb {/*滚动条里面小方块*/
    border-radius: 5px;
    box-shadow: inset 0 0 5px rgba(0,0,0,0.2);
    background: #00ffff33;
  }
  .dialog-pop-body::-webkit-scrollbar-track {/*滚动条里面轨道*/
    box-shadow: inset 0 0 5px rgba(0,0,0,0.2);
    border-radius: 0;
