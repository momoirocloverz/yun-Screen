export const mapBoxStyle2 = {
    ...
    pitch: 0,
    sources: {
        // "mapbox://coding-cheng.cf86to5t": {
        //     url: "mapbox://coding-cheng.cf86to5t",
        //     type: "raster",
        //     tileSize: 256
        // },
        composite: {
    ...
    // "sprite": "mapbox://sprites/coding-cheng/cl25fi5jq00hu15ozxvk9ui91/2yna0py2jef78u0uww71ipv2s",
    ...
    layers: [{
        ...
        },
        {
            ...
            paint: {
                ...
                "line-color": "hsl(0, 87%, 92%)"
            }
        },
        // {
        //     id: "coding-cheng-cf86to5t",
        //     type: "raster",
        //     source: "mapbox://coding-cheng.cf86to5t",
        //     layout: {},
        ...
        },
        {
            ...
            paint: {
                ...
                "line-width": [
                    ...
                    ["zoom"],
                    9, ["match", ["get", "type"], "runway", 1, 0.5],
                    18, ["match", ["get", "type"], "runway", 80, 20]
                ]
            }
        },
        {
        ...
        },
        {
            ...
            minzoom: 15,
            filter: [
                "all", ["==", ["get", "underground"], "false"],
                ["!=", ["get", "extrude"], "false"]
            ],
            layout: {},
            paint: {
                "fill-extrusion-color": "hsl(0, 87%, 71%)",
        ...
        },
        {
            ...
            minzoom: 1,
            filter: [
                "all", ["match", ["get", "disputed"], "true", false, true],
                ["match", ["get", "disputed"], "false", false, true],
                ["==", ["get", "admin_level"], 0],
                ["==", ["get", "maritime"], "false"],
                ["match", ["get", "worldview"],
                    ["all", "CN"], true, false
        ...
        },
        {
            ...
            paint: {
                "text-color": "hsl(0, 76%, 71%)",
                "text-halo-color": "hsl(0, 81%, 93%)",
                "text-halo-width": 0.5
            }
        },
        {
            ...
            paint: {
                "text-color": "hsl(0, 88%, 59%)",
                "text-halo-color": "hsl(0, 88%, 100%)",
                "text-halo-width": 0.5,
                "text-halo-blur": 0.5
            }
        },
        ...
        },
        {
            ...
            paint: {
                "text-color": "hsl(225, 87%, 24%)",
                "text-halo-color": "hsl(225, 100%, 100%)",
                "text-halo-width": 1
            }
        },
        {
            ...
            paint: {
                "text-halo-color": "hsla(0, 93%, 100%, 0.75)",
                "text-halo-width": 1,
                "text-color": "hsl(0, 44%, 24%)",
                "text-halo-blur": 0.5
            }
        },
        {
