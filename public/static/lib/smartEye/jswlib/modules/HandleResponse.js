(function (dMgr) {
    var desModule = function () {
        ...
        this.handleNotify = function (desSession, options, response) {
            ...
            if(msgType == proto.WEBBVCU.MSGType.WEB_BVCU_PUGPS_CHANNEL_DATA){
        ...
        this.internalOnResponseSuccess = function (desSession, options, response, status) {
            ...
            try {
                if (proto.WEBBVCU.MSGType.WEB_GET_DIALOG_INFO == msgType) {
                    data = proto.WEBBVCU.DialogInfo.deserializeBinary(payload).toObject();
                } else if (msgType == proto.WEBBVCU.MSGType.WEB_GET_VERSION_INFO) {
                ...
                } else if (msgType == proto.WEBBVCU.MSGType.WEB_BVCU_NOTIFY) {
                    if (resultCode == jSW.RcCode.RC_CODE_S_OK) {

                    }
                } else if (msgType == proto.WEBBVCU.MSGType.WEB_BVCU_GET_PUBKEY) {
                    if (resultCode == jSW.RcCode.RC_CODE_S_OK) {
                ...
                } else if (msgType == proto.WEBBVCU.MSGType.WEB_BVCU_LOGIN) {
