(function (dMgr) {
    ...
    function OnHTTPPostFileHasResult(rc, nruId, rp, iFileSize, tag) {
        ...
        var cb = tag.cb;
        innerImAfterPostFileSendMsg(_session, targetId, iMsgType, nruId, rp, iFileSize, cb, {}, tag.tag, rc);
    }
    ...
    function UploadMsgItem(inner_session, targetId, msgItem, cb, pcb, tag) {
        var userData = {
            cb: cb,
            pcb: pcb,
            tag: tag,
    ...
    function innerSwConfIMSend(inner_session, options, imsgtype, _dhcb, imsgtypeAppend, bNotSendFile) {
        ...
        if (!CheckMsgItemsContainsFile(options.msgitems) || bNotSendFile || jSWOptions.CheckOcx()) {
            ...
            rc = UploadMsgItem(inner_session, options._targetid, options.msgitems[0],
    ...
    function innerImAfterPostFileSendMsg(inner_session, targetId, iMsgType, nruId, rp, iFileSize, cb, data, tag, sendRc) {
        var rc;
